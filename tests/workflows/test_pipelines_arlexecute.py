...
from workflows.arlexecute.pipelines.pipeline_arlexecute import ical_arlexecute_workflow, continuum_imaging_arlexecute_workflow
...
class TestPipelineGraphs(unittest.TestCase):
    ...
    def test_continuum_imaging_pipeline(self):
        ...
        continuum_imaging_list = \
            continuum_imaging_arlexecute_workflow(self.vis_list, model_imagelist=self.model_imagelist, context='2d',
    ...
    def test_ical_pipeline(self):
        ...
        ical_list = \
            ical_arlexecute_workflow(self.vis_list, model_imagelist=self.model_imagelist, context='2d',
