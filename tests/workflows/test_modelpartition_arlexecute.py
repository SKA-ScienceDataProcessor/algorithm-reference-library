...
from workflows.arlexecute.calibration.modelpartition_arlexecute import solve_modelpartition_arlexecute_workflow
...
class TestCalibrationSkyModelcal(unittest.TestCase):
    ...
    def actualSetup(self, vnchan=1, doiso=True, ntimes=5, flux_limit=2.0, zerow=True, fixed=False):
        ...
        self.dirty_model, sumwt = invert_arlexecute_workflow(self.model_vis, self.beam, context='2d')
        ...
        dirty, sumwt = invert_arlexecute_workflow(lvis, self.beam, context='2d')
        if doiso:
    ...
    def test_modelpartition_solve_arlexecute(self):
        ...
        modelpartition_list = solve_modelpartition_arlexecute_workflow(self.vis, skymodel_list=self.skymodel_list, niter=30,
                                                                       gain=0.25)
        ...
        dirty, sumwt = invert_arlexecute_workflow(residual_vis, self.beam, context='2d')
