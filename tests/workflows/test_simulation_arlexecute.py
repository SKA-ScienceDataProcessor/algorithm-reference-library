...
from workflows.arlexecute.simulation.simulation_arlexecute import simulate_arlexecute_workflow
...
class TestSimulationArlexecuteSupport(unittest.TestCase):
    ...
    def test_create_simulate_vis_list(self):
        vis_list = simulate_arlexecute_workflow(frequency=self.frequency, channel_bandwidth=self.channel_bandwidth)
