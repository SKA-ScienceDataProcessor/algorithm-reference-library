...
class TestCalibrateGraphs(unittest.TestCase):
    ...
    def actualSetUp(self, nfreqwin=3, dopol=False, zerow=True):
        ...
        self.error_blockvis_list = [arlexecute.execute(copy_visibility)(v, zero=True) for v in self.blockvis_list]
        ...
        #
        self.error_blockvis_list = arlexecute.persist(self.error_blockvis_list, sync=True)
