...
def compress_visibility(vis, **kwargs):
    ...
    :param vis: BlockVisibility to be compressed
    ...
    if compression_factor > 0.0:
        ...
        compressed_vis = Visibility(uvw=cuvw, time=ctime, frequency=cfrequency,
...
def decompress_visibility(vis, template_vis, cindex=None, **kwargs):
    ...
    The template BlockVisibility must always be given. This is the BlockVisibility that was compressed.
    ...
    log.info('decompress_visibility: Created new BlockVisibility for decompressed data')
