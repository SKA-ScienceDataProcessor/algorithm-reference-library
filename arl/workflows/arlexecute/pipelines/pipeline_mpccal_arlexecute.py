...
from arl.processing_components.skymodel import update_skymodel_from_image, update_skymodel_from_gaintables
...
from arl.workflows.arlexecute.skymodel.skymodel_arlexecute import convolve_skymodel_list_arlexecute_workflow
...
def mpccal_skymodel_list_arlexecute_workflow(visobs, model, theta_list, nmajor=10, context='2d',
    ...
    for iteration in range(nmajor):
        ...
        def make_residual(dcal, tl, it):
            ...
            # from arl.processing_components.image import show_image
