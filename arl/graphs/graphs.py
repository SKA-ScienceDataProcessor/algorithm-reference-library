...
def create_invert_image_vis_scatter_graph(vis_graph_list, template_model_graph: delayed,
                                          c_invert_vis_scatter_graph=create_invert_vis_scatter_graph,
                                          dopsf=False, normalize=True, facets=2, **kwargs) -> delayed:
