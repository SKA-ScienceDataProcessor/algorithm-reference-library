...
#! The skylake/skylake-himem nodes have 32 CPUs (cores) each. ntasks=64
#SBATCH --ntasks=12
...
#module load intel/bundles/psxe/2017.4
...
#CMD="mpiexec -trace -np $np python $application $options"
CMD="mpiexec -np $np python $application $options"
#CMD="mpirun -ppn $mpi_tasks_per_node -np $np $application $options"
#mpi_tasks_per_node=$[${mpi_tasks_per_node}/2]
#CMD2="mpirun -ppn $mpi_tasks_per_node -np $np $application $options"
