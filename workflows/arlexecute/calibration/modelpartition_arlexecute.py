...
def create_modelpartition_arlexecute_workflow(vislist, skymodel_list, **kwargs):
...
def solve_modelpartition_arlexecute_workflow(vislist, skymodel_list, niter=10, tol=1e-8, gain=0.25, **kwargs):
    ...
    """
    modelpartition_list = create_modelpartition_arlexecute_workflow(vislist, skymodel_list=skymodel_list, **kwargs)
    
    for iter in range(niter):
        evis_all_list = modelpartition_expectation_all_arlexecute_workflow(vislist, modelpartition_list)
        evislist = modelpartition_expectation_step_arlexecute_workflow(vislist, evis_all_list, modelpartition_list, gain=gain,
                                                                       **kwargs)
        new_modelpartition_list = modelpartition_maximisation_step_arlexecute_workflow(evislist, modelpartition_list, **kwargs)
        modelpartition_list = new_modelpartition_list
    
    final_vislist = modelpartition_expectation_all_arlexecute_workflow(vislist, modelpartition_list)
...
def modelpartition_expectation_step_arlexecute_workflow(vislist, evis_all_list, modelpartition_list, **kwargs):
...
def modelpartition_expectation_all_arlexecute_workflow(vislist, modelpartition_list):
    """Calculates E step in equation A12
...
def modelpartition_maximisation_step_arlexecute_workflow(evislist, skymodel_list, **kwargs):
