...
from processing_components.calibration.calskymodel import calskymodel_fit_skymodel, calskymodel_fit_gaintable
...
def initialise_calskymodel_workflow(vislist, skymodel_list, **kwargs):
    """Create the skymodel
...
def calskymodel_expectation_step_workflow(vislist, evis_all_list, calskymodel_list, **kwargs):
...
def calskymodel_expectation_all_workflow(vislist, calskymodel_list):
    """Calculates E step in equation A12
...
def calskymodel_maximisation_step_workflow(evislist, skymodel_list, **kwargs):
...
def calskymodel_solve_workflow(vislist, skymodel_list, niter=10, tol=1e-8, gain=0.25, **kwargs):
    ...
    """
    calskymodel_list = initialise_calskymodel_workflow(vislist, skymodel_list=skymodel_list, **kwargs)
    
    for iter in range(niter):
        evis_all_list = calskymodel_expectation_all_workflow(vislist, calskymodel_list)
        evislist = calskymodel_expectation_step_workflow(vislist, evis_all_list, calskymodel_list, gain=gain, **kwargs)
        new_calskymodel_list = calskymodel_maximisation_step_workflow(evislist, calskymodel_list, **kwargs)
        calskymodel_list = new_calskymodel_list
    
    final_vislist = calskymodel_expectation_all_workflow(vislist, calskymodel_list)
