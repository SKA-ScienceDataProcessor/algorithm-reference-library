...
For example, consider a trivial example to take the square root of an image::
        ...
        def imagerooter(im, **kwargs):
            ...
            return im
        root = generic_image_arlexecute_workflow(imagerooter, myimage,  image_raster_iter, facets=4).compute()
...
def generic_image_iterator_arlexecute_workflow(imagefunction, im: Image, iterator, **kwargs):
    """ Definition of interface for generic_image_arlexecute_workflow
...
def generic_image_arlexecute_workflow(image_unary_function, im: Image, facets=4, overlap=0, **kwargs) :
    """ Definition of interface for generic_image_arlexecute_workflow using scatter/gather
