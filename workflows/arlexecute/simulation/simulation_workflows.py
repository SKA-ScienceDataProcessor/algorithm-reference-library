...
def simulate_workflow(config='LOWBD2',
    ...
    if order == 'time':
        log.debug("simulate_workflow: Simulating distribution in %s" % order)
        vis_list = list()
        ...
        log.debug("simulate_workflow: Simulating distribution in time and frequency")
        vis_list = list()
        ...
        log.debug("simulate_workflow: Simulating into single %s" % format)
        vis_list = list()
