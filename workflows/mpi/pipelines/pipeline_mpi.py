...
def ical_list_mpi_workflow(vis_list, model_imagelist, context='2d',
    ...
    model_vislist = predict_list_mpi_workflow(model_vislist, model_imagelist, context=context, **kwargs)
    if do_selfcal:
        ...
        vis_list = calibrate_list_mpi_workflow(vis_list, model_vislist,
                                                      calibration_context=calibration_context, **kwargs)
        residual_vislist = subtract_list_mpi_workflow(vis_list, model_vislist)
...
def spectral_line_imaging_list_mpi_workflow(vis_list, model_imagelist, continuum_model_imagelist=None,
                                                   context='2d', **kwargs):
    ...
    if continuum_model_imagelist is not None:
        vis_list = predict_list_mpi_workflow(vis_list, continuum_model_imagelist, context=context, **kwargs)
    
    return continuum_imaging_list_mpi_workflow(vis_list, model_imagelist, context=context, **kwargs)
