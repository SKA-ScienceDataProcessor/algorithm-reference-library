...
if __name__ == '__main__':
    ...
    vis_list = simulate_arlexecute('LOWBD2',
                                   rmax=rmax,
                                   frequency=frequency,
    ...
    predicted_vislist = predict_arlexecute(future_vis_graph, gleam_model, context='wstack', vis_slices=vis_slices)
    corrupted_vislist = corrupt_arlexecute(predicted_vislist, phase_error=1.0)
