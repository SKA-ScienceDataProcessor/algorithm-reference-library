...
from functions.visibility import Visibility, simulate, phaserotate, visibility_combine
...
def wcs_from_visibility(vt: Visibility, **kwargs):
    ...
    print("imaging.wcs_from_visibility: Critical cellsize = %f radians, %f degrees" % (criticalcellsize, criticalcellsize*180.0/numpy.pi))
