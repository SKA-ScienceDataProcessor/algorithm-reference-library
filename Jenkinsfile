...
//        }
	...
	stage('Build'){
		...
		py.test tests -n 4 --verbose --cov=processing_library --cov=processing_components --cov=workflows
		--cov-report=html:coverage tests
		'''
 		//Make coverage report
		//coverage html --include=processing_library/*,processing_components/*,workflows/arlexecute,workflows/serial -d
		coverage
            }
        }
